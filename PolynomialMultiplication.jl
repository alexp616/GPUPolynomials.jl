...
println(@benchmark slowMultiply(data, data) setup=(data=[1 for i in 1:rand(1:300)]))
println(@benchmark recursiveMultiply(data, data) setup=(data=[1 for i in 1:rand(1:300)]))
println(@benchmark iterativeMultiply(data, data) setup=(data=[1 for i in 1:rand(1:300)]))
